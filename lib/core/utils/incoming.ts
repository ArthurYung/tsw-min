...
export const captureReadableStream = (stream: NodeJS.ReadableStream): ResponseBodyInfo => {
...
export const captureIncoming = (response: http.IncomingMessage): ResponseBodyInfo =>
  captureReadableStream(response);
